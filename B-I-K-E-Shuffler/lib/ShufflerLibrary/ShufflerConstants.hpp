...
constexpr uint8_t ELEVATOR_STEP_PIN = 3;
constexpr uint8_t ELEVATOR_DIR_PIN = 2;
...
constexpr uint8_t BELT_STEP_PIN = 10;
constexpr uint8_t BELT_DIR_PIN = 11;
...
constexpr uint16_t DROPPER_STEPS_PER_CARD
    = (DROPPER_MM_PER_CARD / DROPPER_MM_PER_REV) * DROPPER_MOTOR_STEPS_PER_REVOLUTION; // [steps]
