...
constexpr uint8_t DISPENSER_RAIL_STEP_PIN = 2;
constexpr uint8_t DISPENSER_RAIL_DIR_PIN = 3;
constexpr uint16_t DISPENSER_RAIL_MAX_STEPS_PER_SECOND = 1000;
constexpr uint16_t DISPENSER_RAIL_STEPS_PER_REVOLUTION = 3200; // Set on the digital driver

constexpr uint8_t ELEVATOR_STEP_PIN = 4;
constexpr uint8_t ELEVATOR_DIR_PIN = 5;
constexpr uint16_t ELEVATOR_MOTOR_MAX_STEPS_PER_SECOND = 1000;
...
constexpr uint8_t NUM_THREE_WIDE_LINKS = 10;
constexpr uint8_t NUM_TWO_WIDE_LINKS = (52 - NUM_THREE_WIDE_LINKS * 3) / 2;
